...
REENTRY_COOLDOWN_SEC="${REENTRY_COOLDOWN_SEC:-300}"
MAX_SELECT_STRIKES="${MAX_SELECT_STRIKES:-3}"
MAX_SPREAD_PCT="${MAX_SPREAD_PCT:-2.5}"
# Risk engine (0 = disabled for all numeric limits)
DAILY_LOSS_LIMIT="${DAILY_LOSS_LIMIT:-0}"
MAX_TRADES_PER_DAY="${MAX_TRADES_PER_DAY:-0}"
MAX_CONCURRENT_POSITIONS="${MAX_CONCURRENT_POSITIONS:-0}"
RISK_PER_TRADE_PCT="${RISK_PER_TRADE_PCT:-0}"
MAX_LOT_MULTIPLIER="${MAX_LOT_MULTIPLIER:-3.0}"
...
cmd=("${PYTHON_BIN}" "${PAPER_SCRIPT}"
  ...
  --reentry-cooldown-sec "${REENTRY_COOLDOWN_SEC}"
  ...
  --max-lot-multiplier "${MAX_LOT_MULTIPLIER}"
